...
$sql = "INSERT INTO Accounts (account_number, account_name, account_type, balance)
...
if (mysqli_query($conn, $sql)) {
    ...
    $sql = "UPDATE Accounts SET account_number = $account_number WHERE account_id = $last_id";
    if (mysqli_query($conn, $sql)) {
